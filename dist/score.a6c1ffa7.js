...
})({"4apWE":[function(require,module,exports) {
...
let game1Chart = new (0, _apexchartsDefault.default)(document.querySelector("#game1-chart"), game1ChartOptions);
game1Chart.render();
let game2Chart = new (0, _apexchartsDefault.default)(document.querySelector("#game2-chart"), game2ChartOptions);
game2Chart.render();
let game3Chart = new (0, _apexchartsDefault.default)(document.querySelector("#game3-chart"), game3ChartOptions);
game3Chart.render();
    ...
    return r(t, [
        ...
        },
        {
            ...
            value: function(t) {
                ...
                if (this.barCtx.isVerticalGroupedRangeBar ? u += c / 2 : u = a.globals.isXNumeric ? h - c / 2 + y : h - A + c / 2 + y, k) u = u + g.height / 2 - v / 2 - 2;
            ...
            value: function(t) {
                ...
                for(var M = n, X = 0; X < a; X++){
                    ...
                    if (w.config.chart.stacked) {
                        if (r > 0 && w.globals.collapsedSeries.length < w.config.series.length - 1) p = this.prevSeriesY[function(t) {
...
}) : "object" === i(exports) && true ? module.exports = zt.document ? Et(zt, zt.document) : function(t) {
...
},{}]},["4apWE","2I7bT"], "2I7bT", "parcelRequire7dae")
